...
export default class blobs extends Component<Props, State> {
	state = {}
	css = {
	}
	render() {
		return (
			<div className='wrap'>
                ...
                M 0, 86
                C 0, 6.019999999999996 6.019999999999996, 0 86, 0
                S 172, 6.019999999999996 172, 86
                    165.98000000000002, 172 86, 172
                    0, 165.98000000000002 0, 86
